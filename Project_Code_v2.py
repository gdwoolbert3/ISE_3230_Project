...
print("Shadow Prices:")
for i in range(len(constraints) - NF):
    print("Shadow Price of Constraint", i, ":", constraints[i].dual_value)
print("Reduced Costs:")
for i in range(NF):
    index = len(constraints) - NF + i
    print("Reduced Cost of X[", i, "]:", constraints[index].dual_value)
